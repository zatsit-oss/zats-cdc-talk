...
export const Feed: React.FC = () => {
  ...
  const handleCreatePost = (content: string, selectedPokemon: { name: string; handle: string; avatar: string }) => {
    const newPost = {
  ...
  return (
    <main className="max-w-2xl mx-auto py-8 space-y-4">
      <header className="mb-4">
        ...
        <p className="text-sm text-slate-500">À la mode Bluesky — posts récents</p>
      </header>
